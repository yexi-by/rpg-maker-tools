...
TERMINOLOGY_TERMS_TABLE_NAME = "terminology_terms"
TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME = "terminology_glossary_terms"
TERMINOLOGY_IMPORT_STATE_TABLE_NAME = "terminology_import_state"
...
TERMINOLOGY_IMPORT_STATE_KEY = "current"
...
CREATE_TERMINOLOGY_TERMS_TABLE = f"""
--sql
    CREATE TABLE IF NOT EXISTS [{TERMINOLOGY_TERMS_TABLE_NAME}] (
        category        TEXT NOT NULL,
...
CREATE_TERMINOLOGY_GLOSSARY_TERMS_TABLE = f"""
--sql
    CREATE TABLE IF NOT EXISTS [{TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME}] (
...
CREATE_TERMINOLOGY_IMPORT_STATE_TABLE = f"""
--sql
    CREATE TABLE IF NOT EXISTS [{TERMINOLOGY_IMPORT_STATE_TABLE_NAME}] (
...
INSERT_TERMINOLOGY_TERM = f"""
--sql
    INSERT OR REPLACE INTO [{TERMINOLOGY_TERMS_TABLE_NAME}]
    (category, source_text, translated_text)
    VALUES (?, ?, ?)
;
"""

INSERT_TERMINOLOGY_GLOSSARY_TERM = f"""
--sql
    INSERT OR REPLACE INTO [{TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME}]
    (source_text, translated_text)
    VALUES (?, ?)
;
"""

UPSERT_TERMINOLOGY_IMPORT_STATE = f"""
--sql
    INSERT OR REPLACE INTO [{TERMINOLOGY_IMPORT_STATE_TABLE_NAME}]
    (state_key, imported)
    VALUES (?, ?)
;
"""
...
SELECT_TERMINOLOGY_TERMS = f"""
--sql
    SELECT category, source_text, translated_text
    FROM [{TERMINOLOGY_TERMS_TABLE_NAME}]
    ORDER BY category, source_text
;
"""

SELECT_TERMINOLOGY_GLOSSARY_TERMS = f"""
--sql
    SELECT source_text, translated_text
    FROM [{TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME}]
    ORDER BY source_text
;
"""

SELECT_TERMINOLOGY_IMPORT_STATE = f"""
--sql
    SELECT state_key
    FROM [{TERMINOLOGY_IMPORT_STATE_TABLE_NAME}]
    WHERE state_key = ?
    LIMIT 1
;
"""
...
DELETE_ALL_TERMINOLOGY_TERMS = f"""
--sql
    DELETE FROM [{TERMINOLOGY_TERMS_TABLE_NAME}]
;
"""

DELETE_ALL_TERMINOLOGY_GLOSSARY_TERMS = f"""
--sql
    DELETE FROM [{TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME}]
;
"""
...
__all__: list[str] = [
    ...
    "TERMINOLOGY_GLOSSARY_TERMS_TABLE_NAME",
    "TERMINOLOGY_IMPORT_STATE_KEY",
    "TERMINOLOGY_IMPORT_STATE_TABLE_NAME",
    "TERMINOLOGY_TERMS_TABLE_NAME",
