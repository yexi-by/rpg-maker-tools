...
from app.cli.commands.rules import (
    ...
    run_import_japanese_residual_rules_command,
    ...
    run_validate_japanese_residual_rules_command,
...
COMMAND_HANDLERS: dict[str, CommandHandler] = {
    ...
    "validate-japanese-residual-rules": run_validate_japanese_residual_rules_command,
    "import-japanese-residual-rules": run_import_japanese_residual_rules_command,
