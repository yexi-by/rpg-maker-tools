...
def test_load_setting_applies_cli_overrides_without_reading_prompt_file(tmp_path: Path) -> None:
...
""",
    ...
    assert setting.llm.base_url == "https://api.example.com"
    assert setting.llm.api_key == "cli-key"
